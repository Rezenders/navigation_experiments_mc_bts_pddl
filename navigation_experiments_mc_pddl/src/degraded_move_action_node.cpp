...
class DegradedMoveAction : public plansys2::ActionExecutorClient
{
public:
  DegradedMoveAction()
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<DegradedMoveAction>();

  node->set_parameter(rclcpp::Parameter("action_name", "degraded_move"));
